...
- [ ] 工具中心：图片压缩、OCR、格式转换等工具真实实现（v0.2.0）
- [ ] 文件管理：本地文件浏览与操作（v0.3.0）
- [ ] AI Agent：模型接入、知识库优先问答（RAG）、对话与工具调用（v0.4.0）
- [ ] 知识库：真实存储、采集、AI 整理与语义检索（v0.5.0）
- [ ] 自动化：定时采集综述、智能复习、工作流编排（v0.6.0）
- [ ] 插件系统：支持第三方工具扩展（v1.0.0）
